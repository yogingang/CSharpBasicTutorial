...
public class OrderingOperators
{
    ...
    public class Test : ITest
    {
        public void Run()
        {
            ...
            //sample.OrderbySyntax();
            //sample.OrderbyProperty();
            //sample.OrderByWithCustomComparer();
            //sample.ThenBySyntax();
            //sample.OrderByDescendingSyntax();
            //sample.ThenByDifferentOrdering();
            sample.OrderingReversal();
